...
<body style ="background: linear-gradient(#e0ffff, #faffff, #e0ffff)">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm sticky-top" style="background: linear-gradient(45deg, blue, green, blue)">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/') }}" style="font-size: ">
                    Lapic
                </a>
