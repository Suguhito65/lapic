...
<body style ="background: linear-gradient(#e0ffff, #faffff, #e0ffff)">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-info shadow-sm sticky-top" style="background: linear-gradient(45deg, orange, red, orange)">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/') }}" style="font-size: 2em">
                    Lap<i class="fas fa-info" style="font-size: 0.6em"></i>c
                </a>
